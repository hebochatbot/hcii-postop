...
exports.heboHttp = function heboHttp (req, res) {
    ...
    switch (intentName) {
      ...
      case "is-it-ok-to-bleed-through-dressing":
        if (isAfterFortyEightHours(timeOfSurgery, currentTime)) {
          response = "It is normal to bleed within the first two weeks. If it has been after two weeks, you should apply pressure to the wound and call your doctor if the bleeding hasn't stopped after 30 minutes."
        } else {
          response = "Bleeding is common in the first 48 hours. You should use a dark towel to apply pressure for 30 minutes. This will help stop the bleeding.";
        }
        break;
      ...
      case "What-if-my-dressing-gets-wet? - yes - yes":
        if (isAfterFortyEightHours(timeOfSurgery, currentTime)) {
          response = "You should change your dressing and clean the wound area.";
        } else {
          response = "Great! It's best to leave your dressing alone. Wait until " + timeOfSurgery.toDateString() + " at " +
                     timeOfSurgery.toLocaleTimeString() + " to change your dressing.";
        }
        break;
      ...
      case "What-if-my-dressing-gets-wet? - no":
        if (isAfterFortyEightHours(timeOfSurgery, currentTime)) {
          response = "You should replace your dressing whenever it gets wet.";
        } else {
          response = "It's best to leave your dressing alone. For now you can try to pat it dry. Wait until " + timeOfSurgery.toDateString() + " at " +
                     timeOfSurgery.toLocaleTimeString() + " to change your dressing.";
        }
        break;
      ...
      case "what-should-i-do-if-the-dressing-is-falling-off":
        if (surgeryArea === "forehead" || surgeryArea === "scalp" || surgeryArea === "back of neck") {
            ...
            response = "You can try adding more tape if your dressing is coming loose.";
        }
        break;
      ...
      case "when-can-i-change-dressing":
        if (isAfterFortyEightHours(timeOfSurgery, currentTime)) {
          ...
          response = "You can change your dressing on" + timeOfSurgery.toDateString() + " at " +
